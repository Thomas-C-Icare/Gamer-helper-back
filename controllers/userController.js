...
const userController = {
  ...
  // ModifyUser allows you to modify user firstname, lastname, pseudo, email and password, The function uses the Sequelize database framework
  ...
  // ModifyBiography allow you to modify user biography
  // The function uses the Sequelize database framework to execute a "findByPk" query on the user model
  // The "findByPk" method allows you to retrieve a user based on their ID
